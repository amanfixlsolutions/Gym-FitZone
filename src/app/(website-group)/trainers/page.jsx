    ...
    <div className="bg-white">
      <section className="min-h-screen flex flex-col justify-center bg-white pt-16">
        <div className="container mx-auto px-4 py-10 text-center">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 mt-2 mb-3">Meet Our <span className="text-amber-500">Expert Trainers</span></h1>
          <div className="w-16 h-0.5 bg-amber-500 mx-auto mb-4" />
          <p className="text-gray-500 text-sm md:text-base max-w-xl mx-auto mb-10">Learn from the best certified fitness professionals in the industry.</p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
            {[{ val: "8+", label: "Expert Trainers" }, { val: "3K+", label: "Happy Clients" }, { val: "15+", label: "Specialties" }, { val: "4.8★", label: "Avg Rating" }].map((s, i) => (
                  ...
                  <div key={i} className="flex-shrink-0 px-2" style={{ width: `${100 / slidesToShow}%` }}>
                    <div className="bg-gradient-to-br from-amber-50 to-white rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 hover:scale-[1.02] cursor-pointer" onClick={() => setSelected(t)}>
                      <div className="relative">
                        <div className="relative w-full pt-[100%]"><img src={t.image} alt={t.name} className="absolute top-0 left-0 w-full h-full object-cover" /></div>
                      ...
                      <div className="p-3">
                        ...
                        <div className="flex gap-2 justify-center mt-2.5">
                          {[FaFacebook, FaInstagram, FaTwitter].map((Icon, j) => (
                            <button key={j} onClick={(e) => openLink("https://example.com", e)} className="w-6 h-6 bg-amber-100 rounded-full flex items-center justify-center hover:bg-amber-500 hover:text-white transition-all duration-300 text-amber-600"><Icon className="w-3 h-3" /></button>
                          ))}
                        </div>
                      </div>
                    </div>
